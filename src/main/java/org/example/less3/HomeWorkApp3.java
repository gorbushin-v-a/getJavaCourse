...
при n = -2 (на два влево) -> [ 6, 1, 3, 5 ]. При каком n в какую сторону сдвиг можете
выбирать сами.
 */
public class HomeWorkApp3 {
    ...
    // TODO Алгоритм неоптимален (n^2).
    //  Возможен алгоритм, когда каждое значение сдвигается сразу на n, "змейкой".
    //  Однако он слишком сложен в реализации (необходимо учитывать переход в другой край массива,это может быть
    //  как одна последовательность символов, так и несколько (если n "хорошо" делится на длину массива)).
    //  Более оптимально использование второго массива, но одним из условий задачи было его запрещение.
